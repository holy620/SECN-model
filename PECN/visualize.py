...
def get_artistic_video_colorizer(
    root_folder: Path = Path('F:\SZ2403147hly\DeOldify-master\DeOldify-master'),
...
def get_image_colorizer(
    root_folder: Path = Path('F:\SZ2403147hly\DeOldify-master\DeOldify-master'), render_factor: int = 35, artistic: bool = True
